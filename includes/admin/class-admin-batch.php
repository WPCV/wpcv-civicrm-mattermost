 ...
 * @since 1.0.0
 */
class WPCV_CiviCRM_Mattermost_Admin_Batch {
	 ...
	 * @since 1.0.0
	 * @access public
	 * @var WPCV_CiviCRM_Mattermost_Admin_Stepper
	 */
	public $stepper;
	...
	public function __construct( $identifier ) {
		...
		$this->stepper = new WPCV_CiviCRM_Mattermost_Admin_Stepper( $identifier );
	...
	public function delete() {
		...
		if ( ! isset( $this->stepper ) ) {
			$this->stepper = new WPCV_CiviCRM_Mattermost_Admin_Stepper( $this->identifier );
		}
		$this->stepper->delete();
		unset( $this->stepper );
