 ...
 * @since 1.0.0
 */
class CRM_Mattermost_Civirules_Actions_Channel_Add extends CRM_Civirules_Action {
	...
	public function processAction( CRM_Civirules_TriggerData_TriggerData $trigger_data ) {
		...
		$response = wpcv_civicrm_mattermost()->mattermost->channel->member_create( $action_params['channel_id'], $user_id );
	 ...
	 * @since 1.0.0
	 *
	 * @return string $label The text explaining the Rule Action condition.
	 */
