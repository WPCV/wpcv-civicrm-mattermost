 ...
 * @since 1.0.0
 */
class CRM_Mattermost_Civirules_Form_Channel_Remove extends CRM_CivirulesActions_Form_Form {
	...
	public function addRules() {
		$this->addFormRule( [ 'CRM_Mattermost_Civirules_Form_Channel_Remove', 'validateChannel' ] );
	}
