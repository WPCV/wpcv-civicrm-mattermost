 ...
 * @package WPCV_CiviCRM_Mattermost
 */
abstract class WPCV_CiviCRM_Mattermost_CLI_Command_Base extends \WP_CLI\CommandWithDBObject {
	...
	protected function site_timezone_get() {
		...
		$tzstring = wp_cache_get( 'wpcvmm_timezone' );
		...
		if ( false === $tzstring ) {
			...
			wp_cache_set( 'wpcvmm_timezone', $tzstring );
