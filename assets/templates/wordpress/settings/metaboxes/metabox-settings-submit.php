...
<div class="submitbox">
	<div id="minor-publishing">
		<div id="misc-publishing-actions">
			<div class="misc-pub-section">
				...
				$misc_pub_section = esc_html__( 'Save your settings here.', 'wpcv-civicrm-mattermost' );
	...
	<div id="major-publishing-actions">
		<div id="publishing-action">
			<?php submit_button( esc_html__( 'Update', 'wpcv-civicrm-mattermost' ), 'primary', $this->form_submit_id, false ); ?>
